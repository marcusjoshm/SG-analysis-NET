#!/usr/bin/env python
"""
Improved training script for stress granule detection
Incorporates enhanced preprocessing, model, and loss functions
"""
...
def improved_train_model(model, train_loader, val_loader, num_epochs=100, learning_rate=1e-4, 
                patience=15, device='cpu', metrics_dir='metrics/improved_training'):
    """
...
def main():
    ...
    print("=" * 60)
    print("Improved Stress Granule Detection Training")
    ...
    # Create metrics directory
    metrics_dir = 'metrics/improved_training'
    os.makedirs(metrics_dir, exist_ok=True)
